...
--               d:/lianxi/RISCVPractice/idealCPU/idealCPU.srcs/sources_1/ip/prgrom/prgrom_sim_netlist.vhdl
-- Design      : prgrom
...
architecture STRUCTURE of prgrom_dist_mem_gen_v8_0_12 is
  ...
  signal \^spo\ : STD_LOGIC_VECTOR ( 31 downto 18 );
begin
  dpo(31) <= \<const0>\;
  dpo(30) <= \<const0>\;
  dpo(29) <= \<const0>\;
...
\synth_options.dist_mem_inst\: entity work.prgrom_dist_mem_gen_v8_0_12_synth
     port map (
      ...
      spo(4) => \^spo\(31),
      spo(3) => \^spo\(26),
      spo(2 downto 1) => \^spo\(24 downto 23),
      spo(0) => \^spo\(18)
    );
end STRUCTURE;
library IEEE;
